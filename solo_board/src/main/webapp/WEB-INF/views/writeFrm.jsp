		...
		<section>
			<div class="content">
				<form action="./boardWrite" class="write-form" method="post" enctype="multipart/form-data">
					...
					<textarea rows="15" class="write-input ta" name="bcontents" placeholder="내용을 적어주세요"></textarea>
					<div class="filebox">
						<!-- 파일 처리 영역 -->
...
<script type="text/javascript">
	//파일이라는 함수위에 체인지가 발생하면 함수 실행하라
	//업로드할 파일을 선택하면 upload-name요소에
	//파일이름을 출력하고 'fileCheck' 요소의 value를 1로 변경
